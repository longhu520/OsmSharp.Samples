...
{
    [Activity(Label = "Android.Routing.Online", MainLauncher = true, Icon = "@drawable/icon")]
    ...
    {   /// <summary>
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            _mapView.MapTilt = 0;
            _mapView.MapCenter = new GeoCoordinate(-22.5613, 17.0846);
            _mapView.MapZoom = 16;
        ...
        async void _mapView_MapTapEvent(GeoCoordinate coordinate)
        {
            if (_previous != null)
            {
                var route = await Router.Calculate(_previous, coordinate);
                _routeLayer.Clear();
                if (route != null)
                {
